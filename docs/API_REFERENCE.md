...
| `WithStrategy(s Strategy)`                      | Sets the queue-selection strategy when a worker is bound to multiple queues. Valid values: `Priority` (default), `RoundRobin`, `MaxLen`, `MinLen`. | `Priority`                                                                                        |
